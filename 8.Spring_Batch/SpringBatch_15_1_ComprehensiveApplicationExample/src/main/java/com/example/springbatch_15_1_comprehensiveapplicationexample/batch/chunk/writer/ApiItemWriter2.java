...
public class ApiItemWriter2 extends FlatFileItemWriter<ApiRequestVO> {
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("/Users/namhyeop/Desktop/git자료/Spring_Boot_Study/8.Spring_Batch/SpringBatch_15_1_ComprehensiveApplicationExample/src/main/resources/product2.txt"));
